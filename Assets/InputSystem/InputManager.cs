...
public partial class @InputManager: IInputActionCollection2, IDisposable
{
    ...
    ~@InputManager()
    {
        ...
        UnityEngine.Debug.Assert(!m_Player_1.enabled, "This will cause a leak and performance issues, InputManager.Player_1.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Player_2.enabled, "This will cause a leak and performance issues, InputManager.Player_2.Disable() has not been called.");
    }
    ...
    public struct Player_1Actions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player_1/Special".
        /// </summary>
    ...
    public struct Player_2Actions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player_2/Special".
        /// </summary>
